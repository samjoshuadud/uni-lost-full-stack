...
import { CheckCircle, Trash, Package } from "lucide-react"
        ...
        {surrenderedItems.length === 0 && (
          <Card>
            <CardContent className="p-8 text-center text-muted-foreground">
              ...
              <p className="font-medium">No surrendered items</p>
              <p className="text-sm">Found items that have been surrendered will appear here</p>
            </CardContent>
          </Card>
        )}
      </div>
